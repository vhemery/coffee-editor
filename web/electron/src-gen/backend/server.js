...
module.exports = (port, host, argv) => Promise.resolve()
    ...
    .then(function () { return Promise.resolve(require('coffee-java-extension/lib/node/backend-extension')).then(load) })
    .then(function () { return Promise.resolve(require('coffee-server/lib/node/backend-module')).then(load) })
    .then(function () { return Promise.resolve(require('coffee-workflow-analyzer-editors/lib/node/backend-extension')).then(load) })
    .then(function () { return Promise.resolve(require('coffee-workflow-analyzer/lib/node/backend-extension')).then(load) })
